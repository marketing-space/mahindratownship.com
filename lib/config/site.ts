...
export const siteConfig = {
  ...
  legal: {
    rera: {
      ...
      description:
        "Runwal 25 Hour has been registered via MahaRERA registration number: P51700048270, P51700048278 and is available on the website <a class='text-blue-500 cursor-pointer hover:text-blue-600' href='https://maharera.mahaonline.gov.in/'>https://maharera.mahaonline.gov.in/</a> under registered projects.",
      details: [
        {
